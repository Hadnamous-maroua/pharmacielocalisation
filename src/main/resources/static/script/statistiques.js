...
/////Nombre de salles par bloc // pharma par ville
$.ajax({
        url: 'villes/count',
        contentType: "application/json",
        dataType: "json",
        ...
        success: function (data, textStatus,
            ...
            var ctx = document.getElementById('byVille').getContext('2d');
            var chart = new Chart(ctx, {
                ...
                options: {
                    title: {
                        display: true,
                        text: 'Nombre de pharmacies par ville',
                        fontSize: 21,
                        padding: 20,
                        fontFamily: 'Calibri',
                    },
...
/////Nombre de salles par bloc // pharma par zone
$.ajax({
        url: 'zones/count',
        contentType: "application/json",
        dataType: "json",
        ...
        success: function (data, textStatus,
            ...
            var ctx = document.getElementById('byZone').getContext('2d');
            var chart = new Chart(ctx, {
                type: 'bar',
                data: {
                    labels: labels,
                ...
                options: {
                    title: {
                        display: true,
                        text: 'Nombre de pharmacies par zone',
                        fontSize: 21,
                        padding: 20,
                        fontFamily: 'Calibri',
                    },
